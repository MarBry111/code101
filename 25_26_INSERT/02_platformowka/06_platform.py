...
while gra_dziala:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_LEFT or event.key == pygame.K_a:
                ...
                X += KROK
                gracz = gracz_p
            elif event.key == pygame.K_SPACE and grawitacja_dziala == False:
                Y -= SKOK
    ...
    elif Y == YP3 - ROZMIAR and X + ROZMIAR > XP3 and X < XP3 + ROZMIAR * 2:
        Y = YP3 - ROZMIAR
        grawitacja_dziala = False
    
    elif Y == YP2 - ROZMIAR and X + ROZMIAR > XP2 and X < XP2 + ROZMIAR * 2:
        Y = YP2 - ROZMIAR
        grawitacja_dziala = False
    
    elif Y == YP1 - ROZMIAR and X + ROZMIAR > XP1 and X < XP1 + ROZMIAR * 2:
        Y = YP1 - ROZMIAR
        grawitacja_dziala = False
