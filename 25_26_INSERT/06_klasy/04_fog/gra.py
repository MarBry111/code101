...
from pomoc import rysuj_mgla, rysuj_poziom, ustaw_ekran
from levels import LEVEL_1, LEVELS
...
while running:
    ...
    rysuj_mgla(level, screen, player)

    if level[player.y][player.x] == "E":
        current_level += 1
        if current_level >= len(LEVELS):
            ...
            level = LEVELS[current_level]
            player.x, player.y = 1, 1  # reset pozycji
