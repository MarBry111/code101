...
class Czolg:
    ...
    def ruszaj(self, event):
        ...
        if self.x < 0 - ROZMIAR/2:
            self.x = SZEROKOSC - ROZMIAR/2
        if self.x > SZEROKOSC - ROZMIAR/2:
            self.x = 0 - ROZMIAR/2
        if self.y < 0 - ROZMIAR/2:
            self.y = WYSOKOSC - ROZMIAR/2
        if self.y > WYSOKOSC - ROZMIAR/2:
            self.y = 0 - ROZMIAR/2
